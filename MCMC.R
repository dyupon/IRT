...
par(mfrow = c(1,1))
burnIn <- 25
hist(mc$chain.theta[1:1000, 1],nclass = 30, main = "Posterior of theta_1")
abline(v = mean(mc$chain.theta[1:1000,1]), col = "red")
hist(mc$chain.beta[1:1000,1],nclass = 30, main = "Posterior of beta_1")
abline(v = mean(mc$chain.beta[1:1000,1]), col = "red")
plot(mc$chain.theta[1:1000,1], type = "l", main = "Chain values of theta_1" )
plot(mc$chain.beta[1:1000,1], type = "l",  main = "Chain values of beta_1" )
